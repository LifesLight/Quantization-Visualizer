...
use crate::quants::{InspectorData, QuantMeta, QuantizeOutput, Settings, TrellisBlockMeta};
use serde::Serialize;
...
pub fn quantize(
    ...
    QuantizeOutput {
        ...
        block_size: t_bsize, super_block_size: 0, imp_size: if is_global { 0 } else { t_bsize }, meta: QuantMeta::Trellis(blocks),
    }
}
